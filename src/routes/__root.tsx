...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "SubTrack — Track every subscription" },
      { property: "og:description", content: "See your true monthly spend across every subscription. Built for clarity." },
